   ...
   public void paint(mGraphics g) {
      ...
      for(i = 0; i < 6; ++i) {
         if (i == this.indexSelect) {
            g.setColor(-15904409);
            g.fillRect(this.xKhungAuto + 4, this.yKhungAuto + 6 + i * this.sizeH, this.wKhungAuto - 8, this.sizeH - 1, true);
         }

         if (i > 0) {
            g.setColor(Res.nColor[1]);
            g.drawLine(this.xKhungAuto + 8, this.yKhungAuto + 5 + i * this.sizeH, this.xKhungAuto + this.wKhungAuto - 8, this.yKhungAuto + 5 + i * this.sizeH, false);
            GameScr.mainChar.paintFriend(g, this.xKhungAuto + 24, this.yKhungAuto + 22 + i * this.sizeH, 1);
            mFont.tahoma_7_white.drawString(g, GameScr.mainChar.name, this.xKhungAuto + 40, this.yKhungAuto - 30 + i * this.sizeH, 0, true);
            mFont.tahoma_7_white.drawString(g, "Lv: " + GameScr.mainChar.lv, this.xKhungAuto + 40, this.yKhungAuto - 16 + i * this.sizeH, 0, true);
         }
      }
