...
implements IActionListener {
    ...
    public static int[] ID_PART_HAIR;
    public static mVector vecItemHair;
    int countL;
    int countR;
    ...
    static {
        ID_PART_HAIR = new int[]{60, 303, 305, 309};
        vecItemHair = new mVector();
    }
    ...
    public void switchToMe(ScreenTeam lastSCR) {
        ...
        int i = 0;
        while (i < arrayNameHair.length) {
            Item ite = (Item)vecItemHair.elementAt(i);
            if (ite != null) {
                ShopHairScreen.arrayNameHair[i] = ite.name;
            }
            ++i;
        }
        ...
        if (itee != null) {
            ...
            this.setShowText(itee.getInfoItemShow(null, true), null, true, false);
        }
        this.c.dir = 0;
    }
    ...
    public void updateKey() {
        ...
        if (GameCanvas.isKeyPressed(6)) {
            this.countR = 5;
            this.indexHair = (byte)(this.indexHair + 1);
            if (this.indexHair > vecItemHair.size() - 1) {
                this.indexHair = 0;
            }
            if ((ite = (Item)vecItemHair.elementAt(this.indexHair)) != null && ite.arrPart != null) {
                this.c.setInfoWearingShopModel(ite.arrPart);
                this.setShowText(ite.getInfoItemShow(null, true), null, true, false);
            }
        }
    ...
    public void paint(mGraphics g) {
        ...
        if (GameScr.mainChar != null) {
            ...
            if (GameCanvas.isTouch) {
                ...
                int hc = mGraphics.getImageHeight(GameScr.imgButton[4]) / 2;
                int wc = mGraphics.getImageWidth(GameScr.imgButton[4]);
                g.drawRegion(GameScr.imgButton[4], 0, (this.isFocusClose ? 1 : 0) * hc, wc, hc, 0, this.xbg + this.wTab - 21, this.yBg - 21, 0, false);
            }
