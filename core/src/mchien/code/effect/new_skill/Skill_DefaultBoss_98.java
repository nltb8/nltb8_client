...
public class Skill_DefaultBoss_98 extends Me_Arrow {
   public int idEffectAuto;

   public Skill_DefaultBoss_98(short x, short y, Actor target, byte type, byte effect, byte lathinh, byte Position, int yadd) {
