   ...
   static synchronized int _01inverse(Block vb, Object vl, float[][] in, int ch, int decodepart) {
      ...
      for(int s = 0; s < look.stages; ++s) {
         ...
         for(int l = 0; i < partvals; ++l) {
            ...
            if (s == 0) {
               for(j = 0; j < ch; ++j) {
                  offset = look.phrasebook.decode(vb.opb);
                  if (offset == -1) {
                     return 0;
                  }

                  _01inverse_partword[j][l] = look.decodemap[offset];
      ...
      for(int s = 0; s < look.stages; ++s) {
         ...
         for(int l = 0; i < partvals; ++l) {
            ...
            if (s == 0) {
               ...
               _2inverse_partword[l] = look.decodemap[offset];
