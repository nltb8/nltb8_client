...
implements IActionListener {
    ...
    public void setInfo() {
        ...
        vecinfo = item.getInfoItemShow(null, true);
        this.arrInfo = mFont.tahoma_7b_white.splitFontArray(info, this.wShow - 10);
        this.setinfovecinfo();
        this.numItemStart = ShowinfoItem.item.plus;
    ...
    public void PaintShowText(mGraphics g) {
        ...
        while (i < vecinfo.size()) {
            ...
            if ((info = (InfoTextShow)vecinfo.elementAt(i)) != null && info.info != null) {
                mFont f = info.f;
    ...
    public void paint(mGraphics g) {
        ...
        int yy2 = 0;
        int i2 = 0;
        while (i2 < this.arrInfo.length) {
            mFont.tahoma_7b_white.drawString(g, this.arrInfo[i2], this.xShow + 10, this.yShow + 7 + yy2, 0, false);
            yy2 += this.disString;
            ++i2;
        }
        super.paint(g);
