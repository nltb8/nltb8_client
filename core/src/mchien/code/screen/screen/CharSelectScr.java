...
public class CharSelectScr extends ScreenTeam implements IActionListener {
   ...
   int ali = 20;
   int hpaint;
   public byte[] list1 = new byte[]{0, 1, 3, 4};
   public byte[] list2 = new byte[]{2, 1, 3, 4};
   ...
   public boolean keyPress(int keyCode) {
      if (this.tfname.isFocus) {
         boolean swallow = this.tfname.keyPressed(keyCode);
         if (swallow) {
            return true;
         }
      }
   ...
   private void paintCharWearing(mGraphics g) {
      ...
      int xShowText1 = x3;
      int wShowText1 = GameCanvas.w - x3 - this.ali + 2;
      int hShowText1 = this.hInfoWearing - 4 - this.size;
      int y2 = GameCanvas.h - yShowText1 - 15 - (GameCanvas.isTouch ? 0 : 20);
      g.setColor(-13232632);
      g.fillRect(x3 - 2, yShowText1, wShowText1, y2, false);
      g.setColor(-1596632);
      g.fillRect(x3 + 1 - 2, yShowText1 + 1, wShowText1 - 2, y2 - 2, false);
      g.setColor(-13232632);
      g.fillRect(x3 + 2 - 2, yShowText1 + 2, wShowText1 - 4, y2 - 4, false);
      g.setColor(-11064572);
      g.fillRect(x3 + 3 - 2, yShowText1 + 3, wShowText1 - 6, y2 - 6, false);
      g.drawRegion(GameScr.imgBoder[6], 0, 0, 9, 9, 7, x3 + wShowText1 - 2, yShowText1 + y2, mGraphics.BOTTOM | mGraphics.RIGHT, false);
      g.drawRegion(GameScr.imgBoder[6], 0, 0, 9, 9, 1, x3 - 2, yShowText1 + y2, mGraphics.BOTTOM | mGraphics.LEFT, false);
      g.drawRegion(GameScr.imgBoder[6], 0, 0, 9, 9, 0, x3 - 2, yShowText1, mGraphics.TOP | mGraphics.LEFT, false);
      g.drawRegion(GameScr.imgBoder[6], 0, 0, 9, 9, 2, x3 + wShowText1 - 2, yShowText1, mGraphics.TOP | mGraphics.RIGHT, false);
      g.setColor(-9751532);
      g.fillRect(xbg + 3, yShowText1, 2 * this.size - 6, hShowText1, false);
      g.fillRect(xbg, yShowText1 + 3, 2 * this.size, hShowText1 - 6, false);
      g.setColor(-12246258);
      g.fillRect(xbg + 3, yShowText1 + 3, 2 * this.size - 6, hShowText1 - 6, false);
      g.setColor(-110);
      g.fillRect(xbg + 3, yShowText1 + 1, 2 * this.size - 6, 1, false);
      g.setColor(-4034289);
      g.fillRect(xbg + 1, yShowText1 + 16, 1, hShowText1 - 18, false);
      g.fillRect(xbg - 2 + 2 * this.size, yShowText1 + 16, 1, hShowText1 - 18, false);
      if (this.indexFocus == 0) {
         g.setColor(-6728397);
         g.fillRect(xbg + 1 + 2, yShowText1 + 3, 2 * this.size - 2 - 4, hShowText1 - 6, false);
      }

      g.setColor(-4760043);
      g.fillRect(xbg + 1 + this.size / 2, hShowText1 - 6 + yShowText1 + 4, this.size, 1, false);
      g.drawRegion(GameScr.imgBoder[4], 0, 0, 16, 16, 0, xbg, yShowText1, mGraphics.TOP | mGraphics.LEFT, false);
      g.drawRegion(GameScr.imgBoder[4], 0, 0, 16, 16, 2, xbg + 2 * this.size, yShowText1, mGraphics.TOP | mGraphics.RIGHT, false);
      ...
      ybg -= hShowText1;
      g.setColor(-9751532);
      g.fillRect(xbg + 3 + x2, ybg, 2 * this.size - 6, hShowText1, false);
      g.fillRect(xbg + x2, ybg + 3, 2 * this.size, hShowText1 - 6, false);
      g.setColor(-12246258);
      g.fillRect(xbg + 3 + x2, ybg + 3, 2 * this.size - 6, hShowText1 - 6, false);
      g.setColor(-110);
      g.fillRect(xbg + 3 + x2, ybg + 1, 2 * this.size - 6, 1, false);
      g.setColor(-4034289);
      g.fillRect(xbg + 1 + x2, ybg + 16, 1, hShowText1 - 18, false);
      g.fillRect(xbg - 2 + 2 * this.size + x2, ybg + 16, 1, hShowText1 - 18, false);
      if (this.indexFocus == 1) {
         g.setColor(-6728397);
         g.fillRect(xbg + x2 + 1 + 2, ybg + 3, 2 * this.size - 2 - 4, hShowText1 - 6, false);
      }

      g.setColor(-4760043);
      g.fillRect(xbg + x2 + 1 + this.size / 2, hShowText1 - 6 + ybg + 4, this.size, 1, false);
      ...
      ybg += hShowText1;
      g.drawRegion(GameScr.imgBoder[4], 0, 16, 16, 16, 0, xbg + x2, ybg, mGraphics.BOTTOM | mGraphics.LEFT, false);
      ...
      if (this.indexFocus != -1) {
         for(i = 0; i < T.infoclass[this.indexFocus].length; ++i) {
      ...
      if(this.indexFocus == 0){
         this.nam.clazz = (byte) clazzcount;
         this.nam.setInfoWearing(Char.idPartTest[clazzcount == 0?Char.THIEU_LAM:clazzcount == 1? Char.VO_DANG:Char.CAI_BANG][0]);
      }else {
         this.nu.clazz = (byte) clazzcount;
         this.nu.setInfoWearing(Char.idPartTest[clazzcount == 0?Char.NGA_MI:Char.NGU_DOC][0]);
      }

      this.nam.paintSelectChar(g, i, ybg + hShowText1 - 15, 0);
      this.nu.paintSelectChar(g, xp2, ybg + hShowText1 - 15, 0);
      g.setColor(-1136094);
      ...
      if (this.indexFocus != -1) {
         ...
         for(i = 0; i < clazzinfo.length; ++i) {
            FontTeam.arialFontW.drawString(g, clazzinfo[i], xShowText1 + 5, yShowText1 + 15 + 20 * text.length + 48 + i * 12, 0, false);
         }
      }
   ...
   public void update() {
      ...
      if (GameCanvas.isTouch) {
         ...
         String[] text = FontTeam.borderFont.splitFontArray(T.monphai, wShowText1);
         if (this.indexFocus != -1) {
            for(int i = 0; i < T.infoclass[this.indexFocus].length; ++i) {
   ...
   public void perform(int idAction, Object p) {
      switch(idAction) {
      case 0:
         GameService.gI().createChar(this.tfname.getText(), (byte) this.clazzcount, (byte) this.indexFocus);
