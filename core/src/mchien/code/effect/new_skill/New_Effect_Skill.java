   ...
   private void setInfo() {
      ...
      case 0:
         ...
         if (this.mst.size() == 1) {
            ...
            if (ac1 != null) {
               for(i = 0; i < 4; ++i) {
                  ac1.x = (short)(ac1.x + this.xArray[i]);
                  this.mst.addElement(ac1);
               }
            }
         }
         ...
         if (this.mst.size() == 2) {
            ac1 = (Actor)this.mst.elementAt(0);
            ac1 = (Actor)this.mst.elementAt(1);
            if (ac1 != null && ac1 != null) {
               this.mst.addElement(ac1);
               this.mst.addElement(ac1);
            }
         }
      ...
      case 1:
         for(i = 0; i < this.mst.size(); ++i) {
            ...
            for(int j = 0; j < 4; ++j) {
               GameCanvas.gameScr.startNewMagicBeam(15, this.mychar, ac, this.x + splashDuaX[this.mychar.dir] + x2[j], this.y + splashDuaY[this.mychar.dir] + y2[j], 0, (byte)0, goc[this.mychar.dir][j]);
            }
         }
      ...
      case 2:
         if (GameCanvas.gameScr.focusedActor != null) {
            for(i = 0; i < this.mst.size(); ++i) {
               ac = (Actor)this.mst.elementAt(i);
               if (ac != null && ac.equals(GameCanvas.gameScr.focusedActor)) {
                  this.target = ac;
      ...
      case 7:
         for(i = 0; i < this.mst.size(); ++i) {
            ac = (Actor)this.mst.elementAt(i);
            if (ac != null) {
               GameCanvas.gameScr.StartNewLazer(this.mychar.x, this.mychar.y, ac.x, ac.y, this.mychar, ac);
            }
         }
      ...
      case 8:
         for(i = 0; i < this.mst.size(); ++i) {
            ac = (Actor)this.mst.elementAt(i);
            if (ac != null) {
               GameCanvas.gameScr.StartNewLightning(ac);
               ac.setMove2Target(this.mychar);
            }
         }
      ...
      case 9:
         for(i = 0; i < this.mst.size(); ++i) {
            ac = (Actor)this.mst.elementAt(i);
            if (ac != null) {
               EffectManager.addHiDataeffectSkill_(55, ac.x, ac.y, 0, this.mychar);
               ac.setMove2Target(this.mychar);
      ...
      case 12:
         for(i = 0; i < this.mst.size(); ++i) {
            ac = (Actor)this.mst.elementAt(i);
            if (ac != null) {
               GameCanvas.gameScr.startNewArrow(this.mychar.x, this.mychar.y, this.mychar, ac, 0, 80, 81, 82, 53, 0, 20);
            }
         }
      ...
      case 18:
         for(i = 0; i < this.mst.size(); ++i) {
            ac = (Actor)this.mst.elementAt(i);
            if (ac != null) {
               GameCanvas.gameScr.startDragon(ac.x - 200, ac.y, ac, 0, 20, 0, 73);
            }
         }
