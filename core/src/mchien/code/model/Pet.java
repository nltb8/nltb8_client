...
import mchien.code.effect.EffectEclip;
import mchien.code.effect.new_skill.Skill_Boss_Noel_1;
...
extends LiveActor {
    ...
    protected final byte DIS_TO_ATTRACT = (byte)80;
    protected final byte DIS_TO_FOLLOW = (byte)40;
        ...
        try {
            ...
            if (deff != null) {
                ...
                if (mons != null) {
                    ...
                    deff.paintnoHeight(g, deff.getFrame(this.frame, status, this.huongY), x, y, this.flip, mons.getImage(0), this.isFly());
                }
            }
    ...
    public void setSpeedInDirection(int max) {
        ...
        this.dir = this.vx > 0 ? (short)3 : (short)2;
    ...
    protected void follow() {
        ...
        if (this.wayPoint.elementAt(0) != null) {
            this.toX = ((Point)this.wayPoint.elementAt((int)0)).x;
            this.toY = ((Point)this.wayPoint.elementAt((int)0)).y;
                        ...
                        if (ac != null) {
                            switch (this.idSkill) {
                                case 0: {
                                    ...
                                    EffectManager.addHiDataeffectSkill(135, (int)ac.x, (int)ac.y, 1);
                                    break;
                                }
                                case 1: {
                                    GameCanvas.gameScr.startFlyText("- " + this.dame[i], 2, ac.x, ac.y, 1, -2, this.x > ac.x ? -1 : 1);
                                ...
                                case 2: {
                                    GameCanvas.gameScr.startNewMagicBeam(20, (Actor)this, ac, (int)this.x, (int)this.y, this.dame[i], -1);
                                    break;
                                }
                                case 3: {
                                    if (i == 0) {
                                        ...
                                        EffectManager.addHiDataeffectSkill(120, (int)this.x, (int)this.y, 1);
                                    }
                                    GameCanvas.gameScr.startFlyText("- " + this.dame[i], 2, ac.x, ac.y, 1, -2, this.x > ac.x ? -1 : 1);
                                    EffectManager.addHiDataeffectSkill(135, (int)ac.x, (int)ac.y, 1);
                                    break;
