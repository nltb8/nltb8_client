...
import mchien.code.effect.new_skill.BigLaze;
import mchien.code.effect.new_skill.Eff_set;
import mchien.code.effect.new_skill.EffectSkill;
import mchien.code.effect.new_skill.Effect_Cung_T4;
import mchien.code.effect.new_skill.Effect_Sao_chop;
import mchien.code.effect.new_skill.Me_Arrow;
import mchien.code.effect.new_skill.New_Effect_Skill;
import mchien.code.effect.new_skill.Skill_Bua_T3;
import mchien.code.effect.new_skill.Skill_Bua_T4;
import mchien.code.effect.new_skill.Skill_Bua_T5;
import mchien.code.effect.new_skill.Skill_Cung_T3;
import mchien.code.effect.new_skill.Skill_Cung_T5;
import mchien.code.effect.new_skill.Skill_Dao_T1;
import mchien.code.effect.new_skill.Skill_Dao_T5;
import mchien.code.effect.new_skill.Skill_Dao_T6;
import mchien.code.effect.new_skill.Skill_Kiem_2019;
import mchien.code.effect.new_skill.Skill_Kiem_T2;
import mchien.code.effect.new_skill.Skill_Kiem_T4;
import mchien.code.effect.new_skill.Skill_Kiem_T5;
import mchien.code.effect.new_skill.Skill_Kiem_T7;
import mchien.code.effect.new_skill.Skill_Normal;
import mchien.code.effect.new_skill.Skill_Phapsu_T3;
import mchien.code.effect.new_skill.Skill_Phapsu_T5;
import mchien.code.effect.new_skill.Skill_TrucLam_2019;
import mchien.code.effect.new_skill.Skill_bua_T1;
import mchien.code.effect.new_skill.Skill_doc_2019;
...
public class DataSkillEff extends Effect {
   ...
   byte delay;
   int idEffectData = 0;
   public mVector vecmySkil = new mVector();
   short[] arrRadian = new short[]{0, 60, 120, 180, 240, 300};
   ...
   public static void checkremove() {
      Enumeration k = GameData.listbyteData.keys();
   ...
   public byte[][] getFrameChar() {
      ...
      return eff != null && (eff == null || eff.isLoadData) ? eff.frameChar : new byte[4][];
   }

   public byte[] getIndexSplash() {
      EffectData eff = GameData.getByteData((short)(this.idEff + Res.ID_START_SKILL));
      return eff != null && (eff == null || eff.isLoadData) ? eff.indexSplash : null;
   }
   ...
   public void addDame() {
      ...
      if (this.idSkill != 2 && this.idSkill != 8 && this.idSkill != 9) {
         for(i = 0; i < this.vecmySkil.size(); ++i) {
            Effect eff = (Effect)this.vecmySkil.elementAt(i);
            if (eff != null && eff.getDame() <= 0) {
   ...
   public int getWidth() {
      EffectData eff = (EffectData)GameData.listbyteData.get("" + (this.idEff + Res.ID_START_SKILL));
      return eff != null && (eff == null || eff.isLoadData) ? eff.fw : 0;
   }

   public int getHeight() {
      EffectData eff = GameData.getByteData((short)(this.idEff + Res.ID_START_SKILL));
      return eff != null && (eff == null || eff.isLoadData) ? eff.fh : 0;
   }
   ...
   public int countTotalFrame() {
      EffectData eff = (EffectData)GameData.listbyteData.get("" + (this.idEff + Res.ID_START_SKILL));
      return eff != null && (eff == null || eff.isLoadData) ? eff.listFrame.size() : 0;
   }
}
