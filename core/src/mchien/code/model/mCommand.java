...
public class mCommand {
    ...
    public int x = -1;
    public int y = -1;
    public int wCmd = ScreenTeam.cmdW;
    public int hCmd = ScreenTeam.cmdH;
    int lenCaption = 0;
    public boolean isFocus = false;
    public Object p;
    public Object mpaint;
    private byte indexImg = 0;
    ...
    public void paint(mGraphics g) {
        ...
        if ((this.caption != "" || this.indexImg != 0) && GameCanvas.isTouch && !this.isLine) {
        ...
        if (this.isLine) {
            align = 0;
            xs = 0;
            mFont.tahoma_7b_black.drawString(g, this.caption, this.x + xs + 1, this.y + (ys /= 2) + 1, align, false);
            ...
            if (this.indexImg == 2) {
                ...
                int i = 0;
                while (i < this.subCaption.length) {
    ...
    public void paint(mGraphics g, boolean isClip) {
        ...
        if (this.isLine) {
            align = 0;
            xs = 0;
            mFont.tahoma_7b_black.drawString(g, this.caption, this.x + xs + 1, this.y + (ys /= 2) + 1, align, isClip);
            if (mSystem.isAndroid) {
