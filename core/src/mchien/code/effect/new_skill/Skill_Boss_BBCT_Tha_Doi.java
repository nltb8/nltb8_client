...
public class Skill_Boss_BBCT_Tha_Doi extends Effect {
   mVector allTarget;
   int xTo = -1;
   int yTo = -1;
   int indexDame;
   int[] lastPositionBoss;
   BossBienBucCongTu Boss;
   int timeDelay;
   boolean isGetPosition;

   public Skill_Boss_BBCT_Tha_Doi(mVector allTarget, BossBienBucCongTu Boss, int[] arrayDam) {
