...
public class Skill_DefaultBoss_BienBucTuongQuan extends Me_Arrow {
   public int idEffectAuto;

   public Skill_DefaultBoss_BienBucTuongQuan(short x, short y, Actor target, byte type, byte effect, byte lathinh, byte Position, int yadd) {
